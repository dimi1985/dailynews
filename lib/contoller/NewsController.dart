...
class NewsController extends GetxController {
  ...
  getNews({channel = '', searchKey = '', reload = false}) async {
    ...
    if (channel != '') {
      ...
      category.value = '';
      baseApi =
          "https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&sources=$channel&apiKey=324a14bdfc544adda506cb7dcb5ec4d8";
    }
    if (searchKey != '') {
      country.value = '';
      category.value = '';
      baseApi =
          "https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&q=$searchKey&apiKey=324a14bdfc544adda506cb7dcb5ec4d8";
    }
    print(baseApi);
